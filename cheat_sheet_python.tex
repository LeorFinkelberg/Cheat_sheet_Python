...
Можно указывать относительный путь, а можно абсолютный, но от \emph{директории поиска} (например, \verb|./src|). То есть, если
\begin{lstlisting}[
style = bash,
numbers = none
]
...
# поиск пакета начнется со сканирования src/
