...
\emph{Аргументы функции контрвариантны}: то есть если функция ожидает получить объект какого-то типа, то вместо этого типа можно передать и его родительский тип.
